...
class OneSignalServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->singleton('onesignal', function ($app) {
            ...
            return new OneSignalClient($config['app_id'], $config['rest_api_key'], $config['user_auth_key'] , $config['guzzle_client_timeout'], $config['proxy_url']);
        });

        $this->app->alias('onesignal', 'Karu\OneSignal\OneSignalClient');
    }
